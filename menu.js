document.addEventListener("DOMContentLoaded", () => {
    ...
    // se a função foi removida por que ainda é exportada ela no game.js?
    ...
    function createMenuProfile() {
        ...
        // --- CONTEÚDO DO PAINEL ---
        // Por que não fez isso num arquivo separado?
        menuProfilePanel.innerHTML = `
            ...
            <div style="display: flex; align-items: center; gap: 20px; background-color: #2a2a2e; padding: 20px; border-radius: 10px;">
                <div id="menuProfilePic" style="width: 70px; height: 70px; border-radius: 50%; background-color: #3a3a3e; background-size: cover; background-position: center; border: 2px solid #2ecc71;">
                </div>
            ...
            <div class="profile-section">
                ...
                <div style="display: flex; gap: 10px;"><input type="text" id="menuFriendInput" class="profile-input" placeholder="Nome do jogador">
...
`;
    ...
    // Notificação do pedido de amizade
    ...
    function updateFriendsUI() {
        ...
        userProfile.requests.forEach(rqst => {
            const li = document.createElement("li");
            const nameSpan = document.createElement('span');
            nameSpan.textContent = rqst;
            ...
            accept.onclick = () => {
                ...
                userProfile.friends.push(rqst);
                userProfile.requests = userProfile.requests.filter(req => req !== rqst);
                updateFriendsUI();
            };
